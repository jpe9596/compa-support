...
This Privacy Policy describes how your personal information is collected, used, and shared when you use the Compa app ("the App"). Compa is a recovery companion app that handles **sensitive health-related information** including addiction recovery data. We are deeply committed to protecting your privacy.
...
**All persistent data is stored locally on your device.** Specifically:
...
**No Account Required**: The App does not require you to create an account. We do not collect email addresses, phone numbers, or any personal identifiers beyond the optional first name you may share with the AI companions.

## In-App Purchases

Compa Premium subscriptions are processed entirely by Apple through StoreKit. We do not collect or have access to your payment information (credit card numbers, billing address, etc.). Subscription status is verified locally on your device through Apple's transaction system. Please refer to [Apple's Privacy Policy](https://www.apple.com/privacy/) for how Apple handles payment data.
...
- **Revoke Permissions**: Revoke notification access at any time through iOS Settings → Compa → Notifications
- **Opt Out of Name Sharing**: You can choose not to provide your name to AI companions
- **Full Control**: All data is on your device — you have complete control over it at all times

## Data Portability

Since all data is stored locally on your device, it is included in your standard iCloud or iTunes/Finder backups. The App does not currently offer a standalone data export feature.
...
- Apple App Store Guidelines (including Guideline 5.1.1 — Data Collection and Storage)
